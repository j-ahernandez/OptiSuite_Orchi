            ...
            TD::make('Acciones')
                ...
                ->render(function ($model) {
                    return DropDown::make()
                        ...
                        ->list([
                            Link::make('Ver')
                                ->route('platform.resource.view', ['resource' => 'molde-resources', 'id' => $model->id])
                                ->icon('eye'),
                            Link::make('Editar')
                                ->route('platform.resource.edit', ['resource' => 'molde-resources', 'id' => $model->id])
                                ->icon('pencil'),
